...
| Name | Description |
|------|-------------|
| `ast` | Numeric vector of aspartate aminotransferase concentrations (IU/L) |
| `ulnast` | Numeric vector of upper limit of normal AST values (IU/L). Typically 33 IU/L for most laboratories |
| `bili` | Numeric vector of total bilirubin concentrations (mg/dL) |
| `ulnbili` | Numeric vector of upper limit of normal bilirubin values (mg/dL). Typically 1.2 mg/dL for most laboratories |

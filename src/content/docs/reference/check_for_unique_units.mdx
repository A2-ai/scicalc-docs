---
title: "Gives a TRUE/FALSE for if the Parameters have only 1 associated unit"
description: "Gives a TRUE/FALSE for if the Parameters have only 1 associated unit"
---

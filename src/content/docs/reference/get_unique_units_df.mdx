---
title: "Creates a dataframe with distinct parameters and units combinations"
description: "Creates a dataframe with distinct parameters and units combinations"
---

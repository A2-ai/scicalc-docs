...
description: "This function categorizes hepatic function impairment using the National Cancer Institute Organ Dysfunction Working Group (NCI-ODWG) criteria."
---
...
import exampleOutput from '/examples/text/hfc.txt?raw';

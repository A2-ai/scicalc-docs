...
I’ll first try and read in data from `~/inst/extdata/data/source` - in R
packages extra files go in the `inst` directory, but we can pretend this
is just like a Project starter `data/source` directory.
...
#> dm.sas7bdat: 6a9ae5c52a792fb87cc07ea6eed71042
...
#> pc.parquet: 11768bdc82b792c3e73394632869466c
...
#> vs.parquet: 1a7dbc83f571637aa9608717238a2970
```
...
raw_data <- purrr::map(
  ...
  purrr::set_names(tools::file_path_sans_ext(list.files(data_source)))
#> dm.sas7bdat: 1068e4788d4b8d0298dbf7f5493731260236282b14e3db366dffe29eed95e0ac
...
#> ℹ Use `spec()` to retrieve the full column specification for this data.
#> ℹ Specify the column types or set `show_col_types = FALSE` to quiet this message.
#> pc.parquet: 845a06bb7b1f65e495511096ee82ebe74ff69ff564df0e4495f29626a6a3b8c8
#> test_excel.xlsx: 99bf0f59e74683f3173aba85b083dd928f827d6619b01e1afe80dc1830e7859d
#> Sheets in test_excel.xlsx: model_summary, sheet with space, empty
#> Warning in .f(.x[[i]], ...): File type: txt not currently supported
#> vs.parquet: 6a45db71d45f82e0a4ac443aff5ce7ffe7703ee3a1dc1d4f17b9ba43e1a022d7
```
...
#> [1] "Overwriting data!"
#> /Users/mattsmith/Documents/scicalc/inst/extdata/data/derived/pk_data_v01.parquet: c6aa6463a5a3e09c867a23acd0465e2f539502e5ca5805ee6f3fba30b9493608
```
...
print(hash)
#> [1] "292240dd3c7b109559123aaa7b161af9"
...
print(correct_hash)
#> [1] "c6aa6463a5a3e09c867a23acd0465e2f539502e5ca5805ee6f3fba30b9493608"
```
...
print(md5_hash)
#> [1] "20c5558174552a787d4572a4534a3b3e"
```
